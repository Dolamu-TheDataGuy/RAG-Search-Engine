...
from lib.keyword_search import InvertedIndex, search_command, build_command, tf_command, idf_command, tf_idf_command, bm25_idf_command, bm25_tf_command, bm25_search_command
...
def main() -> None:
    ...
    match args.command:
        ...
        case "bm25search":
            doc_score_map_objects = bm25_search_command(args.query, args.limit)
            for i, object in enumerate(doc_score_map_objects, start=1):
                doc_id, movie, score = object
